 ...
 * TraitRoll chat messages cover attacks; swadeTakeDamage fires when wounds are applied.
 */
export class SWADEAdapter extends SystemAdapter {
    static TRACE_PREFIX = "[NativeSWADE]";

    /**
     * SWADE wounds increase when damage is taken (not a standard HP-down pool).
     */
